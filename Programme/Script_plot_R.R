...
data <- read_csv("./SAS-PROJET-grp4/data/R_data.csv")

# plot desc cohorte large, par genre

data |> group_by(group_age,sexe) |> 
  ...
  scale_color_discrete(labels=c('Femme','Rural'))+  
  theme_bw()+
...
# plot cohorte large, par genre, milieu
...
# plot cohorte large, par genre et region
